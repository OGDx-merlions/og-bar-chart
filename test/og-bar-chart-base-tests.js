...
function runBaseTests() {
  og_bar_chart_1 = document.getElementById('og_bar_chart_1');

  suite('Base Automation Tests for og-bar-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-bar-chart fixture is created', function() {
      assert.isTrue(document.getElementById('og_bar_chart_1') !== null);
    });
